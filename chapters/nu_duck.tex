...
This work, \Cref{sec:glory_duck}, and accelerations, \Cref{sec:multithread}, has laid the groundwork for faster DM searches without sacrificing on the scientific rigor.
...
Here I show some preliminary work done to combine HAWC and IceCube data for a multi-messenger DM search.
