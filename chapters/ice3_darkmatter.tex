...
\begin{figure}
    \centering{
        \includegraphics[scale=0.27]{figures/ic_DM/dm_plots/Segue1_bb_chi2_Masspanel.pdf}
    }\caption{Each subplot, except the final, is the TS distribution for a specific DM mass listed in the subplot. The final subplot plots the all DM spectral models used as input for the TS distribution calculations with bluer lines indicating lower DM mass and redder indicating higher DM mass.}
    \label{fig:icDM_Seg1_TS}
\end{figure}
