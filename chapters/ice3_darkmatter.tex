...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tmpfig{Earth attenutation diagram.}
...
The sensitivity studies performed for each source (\cref{fig:icDM_sensitivity_2of2}and \todo{refer to appendx ns plots}) provided $n_s$ for 1000 trials which we use as inputs into \cref{eq:sv_from_nsig}.
We derive \sv~using $\log_{10}\J = 19.42~\log_{10}$(GeV$^2$cm$^{-5}$)
\todo{refer to figure} shows the results of these calculations.

\tmpfig{Declination sensitivity plot}

\todo{refer to fig} shows that we have significant but diminishing sensitivity to source at high declination.
