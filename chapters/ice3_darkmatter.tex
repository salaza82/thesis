...
\Cref{sec:icDM_TSperSrc} shows the background TS distributions obtained for Segue 1, a source with little Earth attenuation and a large \J-factor, and Ursa Major II, which has a similarly large \J-factor but significantly more Earth attenuation.
The select DM annihilation channels shown are \parpar{b}, \parpar{e}, \parpar{\mu}, \parpar{\tau}, \parpar{\nu_e}, \parpar{\nu_\mu}, and \parpar{\nu_\tau}.
I also show the TS distributions of a stacked study of 15 sources for all DM annihilation channels.

\begin{figure}[!h]
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_bb_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_ee_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Segue 1 $\chi\chi \rightarrow$ \parpar{e}.}
    \label{fig:icDM_Seg1ee_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_mumu_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Segue 1 $\chi\chi \rightarrow$ \parpar{\mu}.}
    \label{fig:icDM_Seg1mu_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_tautau_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_nuenue_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Segue 1 $\chi\chi \rightarrow$ \parpar{\nu_e}.}
    \label{fig:icDM_Seg1nue_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_numunumu_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Segue 1 $\chi\chi \rightarrow$ \parpar{\nu_\mu}.}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/Segue1_nutaunutau_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Segue 1 $\chi\chi \rightarrow$ \parpar{\nu_\tau}.}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_bb_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{b}.}
    \label{fig:icDM_UMa2bb_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_ee_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{e}.}
    \label{fig:icDM_UMa2e_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_mumu_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{\mu}.}
    \label{fig:icDM_UMa2mu_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_tautau_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{\tau}.}
    \label{fig:icDM_UMa2tau_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_nuenue_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{\nu_e}.}
    \label{fig:icDM_UMa2nue_TS}
\end{figure}

\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_numunumu_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{\nu_\mu}.}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/UrsaMajorII_nutaunutau_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for Ursa Major II $\chi\chi \rightarrow$ \parpar{\nu_\tau}.}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_bb_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_tt_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_uu_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_dd_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_ee_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_mumu_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_tautau_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_WW_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_ZZ_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_nuenue_chi2_Masspanel_2024-04-28.pdf}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_numunumu_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for 15 stacked, \GS \J-factor sources and $\chi\chi \rightarrow$ \parpar{\nu_\mu}.}
...
\begin{figure}
    \centering{
        \includegraphics[clip, trim=5cm 6.5cm 4.9cm 8cm, scale=0.345]{figures/ic_DM/dm_plots/stacked_nutaunutau_chi2_Masspanel_2024-04-28.pdf}
    }\caption{Same as \cref{fig:icDM_Seg1bb_TS} for 15 stacked, \GS \J-factor sources and $\chi\chi \rightarrow$ \parpar{\nu_\tau}.}
    \label{fig:icDM_stact_nutau_TS}
\end{figure}
...
\Crefrange{fig:icDM_Seg1bb_TS}{fig:icDM_UMa2nutau_TS} present some TS distributions for Segue 1 and Ursa Major II for 100,000 trials.
...
\Crefrange{fig:icDM_stact_bb_TS}{fig:icDM_stact_nutau_TS} present the TS distributions for a stacked study of 15 sources with \GS \J-factors on 100,000 trials.
...
\Cref{fig:icDM_sensitivity_1of2,fig:icDM_sensitivity_2of2} show the sensitivities for the DM annihilation channels studied here.

\clearpage

\begin{figure}[h!]
    \centering{
        \includegraphics[scale=0.265]{figures/ic_DM/dm_plots/ee_money_plot_comb.pdf}
        \includegraphics[scale=0.265]{figures/ic_DM/dm_plots/nuenue_money_plot_comb.pdf}
