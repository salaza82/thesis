...
\centering{
    \begin{tabular}{cccc}
        ...
        $\chi\chi \rightarrow b\bar{b}$ &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_bb.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Segue1_bb.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Sextans_bb.pdf} \\
        $\chi\chi \rightarrow tau\overline{tau}$ &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_tautau.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Segue1_tautau.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Sextans_tautau.pdf} \\
        $\chi\chi \rightarrow ZZ$ &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_zz.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Segue1_zz.pdf} &
        \includegraphics[scale=0.18]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_Sextans_zz.pdf} \\
    \end{tabular}
    }
    \caption{\todo{fill this out}}
