...
Previously, the likelihood was minimized one model at a time and trivially parallelized for each permutation of the two lists: CHANS (SM annihilation channel) and 
