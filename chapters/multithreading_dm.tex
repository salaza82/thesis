...
\Cref{fig:pppc_vs_hdm} demonstrates the impact of changes from HDM on DM annihilation to W bosons.
...
% \begin{figure}[t]
    ...
    % \begin{tabular}{c|ccc}
        % Source & $-1 \sigma$ & Median & $+1 \sigma$ \\
        % \rotatebox[origin=c]{90}{Coma Berenices} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/ComaBerenices_Dm1_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/ComaBerenices_D_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/ComaBerenices_Dp1_plot.pdf} }\\
        % \rotatebox[origin=c]{90}{Draco} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Draco_Dm1_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Draco_D_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Draco_Dp1_plot.pdf}} \\
        % \rotatebox[origin=c]{90}{Segue1} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Segue1_Dm1_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Segue1_D_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Segue1_Dp1_plot.pdf}} \\
        % \rotatebox[origin=c]{90}{Sextans} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Sextans_Dm1_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Sextans_D_plot.pdf}} &
        % \raisebox{-.5\height}{\includegraphics[scale=0.275]{figures/mtd_hawc_dm/Sextans_Dp1_plot.pdf}} \\
    % \end{tabular}
    % }
    % \caption{This is a caption}
    % \label{fig:ls20_dfac_maps}
% \end{figure}