...
\begin{figure}
    ...
    \caption{$\frac{d\J}{d\Omega}$ maps for Segue1 (top) and Coma Berenices (bottom). Origin is centered on the specific dwarf spheroidal galaxies (dSph). X and Y axes are the angular separation from the center of the dwarf. Plots of the remaining 11 dSph HAWC studied are linked in \todo{cref to appendix}.}\label{fig:gd_spatialmodel}
\end{figure}
