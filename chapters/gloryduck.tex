...
The results on fitting to HAWC's poisson trials of the DM hypothesis is shown in \Cref{fig:hawc_brazil_band} for all of the DM annihilation channels studied for Glory Duck.
...
Even though some of the remaining dSphs have large \J factors, they are towards the edge of HAWC's field of view where HAWC analysis is less sensitive.
