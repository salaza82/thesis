...
The electroweak corrections were previously not considered for HAWC and are significant for DM annihilating to \todo{fill in SM particles} \cite{Albert_2018}.
\tmpfig{figure from PPPC showing difference in pythia and ew corrections.}

The class in atromodels created to include the PPPC is aptly named \texttt{PPPCSpectra} within \texttt{DM\_models.py}.
