%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Remaining Spectral Models}\label{sec:pdx_spec_mdls}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Comparison with Glory Duck}\label{sec:apx_gd_vs_mtd}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{figure}[h]
\centering{
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_bb.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_tt.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_ww.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_ee.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_mumu.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_tautau.pdf}
    \includegraphics[scale=0.225]{figures/mtd_hawc_dm/systematics/Systematic_GD_New_duck_ComaBerenices_zz.pdf}
    }
